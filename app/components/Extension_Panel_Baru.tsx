...
export default function Extension_Panel_Baru() {
  const tabs = [
    {
      id: "content",
  ...
  return (
    <div style={{ display: "flex", gap: "24px", padding: "32px", minHeight: "100vh", backgroundColor: "#f5f5f0" }}>
      {/* PANEL UTAMA */}
      <div
        style={{
          width: "400px",
      ...
      >
        ...
        <div style={{ backgroundColor: "#1a4d3a", padding: "20px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "16px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <div style={{ backgroundColor: "rgba(255,255,255,0.95)", padding: "6px", borderRadius: "8px" }}>
                <svg
              ...
              <div>
                <h1 style={{ color: "white", fontWeight: 600, fontSize: "16px", margin: 0 }}>
                  IP Shield
                </h1>
                <p style={{ color: "#8dc9b0", fontSize: "12px", margin: 0 }}>Yakoa × Story</p>
              </div>
            </div>
            ...
            >
              <div style={{ width: "6px", height: "6px", backgroundColor: "#8dc9b0", borderRadius: "50%" }}></div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "8px" }}>
            {[
              ...
              >
                <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "10px", margin: "0 0 2px 0" }}>
                  {stat.label}
                </p>
                <p style={{ color: "white", fontWeight: 600, fontSize: "16px", margin: 0 }}>{stat.value}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ padding: "20px" }}>
          {/* Tab Navigation */}
          <div style={{ backgroundColor: "rgba(255,255,255,0.8)", borderRadius: "8px", padding: "4px", display: "flex", gap: "6px", marginBottom: "16px" }}>
            {tabs.map((tab) => (
              <button
                key={tab.id}
                ...
                style={{
                  ...
                  cursor: "pointer",
                  transition: "all 0.2s",
                  backgroundColor: active === tab.id ? "#1a4d3a" : "transparent",
                  color: active === tab.id ? "white" : "rgba(26, 77, 58, 0.6)",
                  boxShadow: active === tab.id ? "0 2px 8px rgba(26, 77, 58, 0.3)" : "none",
                }}
              >
                {tab.icon}
                <span style={{ fontSize: "10px", fontWeight: 500, textAlign: "center", lineHeight: "1.2" }}>
                  {tab.title}
                </span>
              </button>
            ))}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              ...
              >
                <div style={{ color: "white", transform: "scale(1.25)" }}>{current?.icon}</div>
              </div>
            </div>

            {/* Text */}
            <div style={{ textAlign: "center" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 600, color: "#1a4d3a", margin: "0 0 4px 0" }}>
                {current?.title}
              </h2>
              <p style={{ fontSize: "12px", color: "rgba(26, 77, 58, 0.6)", lineHeight: "1.5", margin: 0, padding: "0 12px" }}>
                {current?.description}
              </p>
            </div>
            ...
            <button
              ...
              onMouseOver={(e) => {
                e.currentTarget.style.boxShadow = "0 6px 16px rgba(26, 77, 58, 0.4)";
                e.currentTarget.style.transform = "translateY(-1px)";
              }}
              onMouseOut={(e) => {
                e.currentTarget.style.boxShadow = "0 4px 12px rgba(26, 77, 58, 0.3)";
            ...
            >
              <div style={{ display: "flex", alignItems: "flex-start", gap: "8px" }}>
                <svg
                  style={{ width: "16px", height: "16px", color: "#27835c", marginTop: "2px", flexShrink: 0 }}
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
                ...
                <div>
                  ...
                  <p style={{ fontSize: "12px", color: "rgba(26, 77, 58, 0.7)", lineHeight: "1.5", margin: 0 }}>
                    {active === "content" &&
          ...
          >
            {detectedContent.map((content) => (
              <div
                ...
                onMouseOver={(e) => {
                  e.currentTarget.style.boxShadow = "0 4px 12px rgba(26, 77, 58, 0.15)";
                }}
                onMouseOut={(e) => {
                  ...
                  <div style={{ display: "flex", gap: "8px", paddingTop: "4px" }}>
                    {content.status === "original" ? (
                      ...
                      <button
                        ...
                        onMouseOver={(e) => {
                          e.currentTarget.style.backgroundColor = "rgba(141, 201, 176, 0.3)";
                        }}
                        onMouseOut={(e) => {
                          e.currentTarget.style.backgroundColor = "rgba(141, 201, 176, 0.2)";
                        }}
                      >
                        View Details
                      </button>
